...
import 'package:kbcgame/screens/lost_page.dart';
import 'dart:math';
import 'package:kbcgame/screens/score_page.dart';
import 'package:kbcgame/screens/won_page.dart';
 void main() {
  runApp(
    MaterialApp(
...
class _HomepageState extends State<Homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: const Text("QUIZ APP 🤔",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
        centerTitle: true,
      ),
      body: Column(
        children: [
